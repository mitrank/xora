...
const Header = () => {
  ...
  return (
    <header className="w-full fixed top-0 left-0 z-50 py-10">
      <div className="container flex h-14 items-center max-lg:px-5">
        ...
        <div
          ...
          <div
            ...
            <div
              className="lg:hidden block absolute top-1/2 left-0 w-[960px] h-[380px] -translate-x-[275px] -translate-y-1/2 rotate-90">
